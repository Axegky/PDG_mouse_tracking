...
<FORM id="mlwebform" name="mlwebform" onSubmit="return checkForm(this)" method="POST" action="save.php">
            ...
            <input id="expName" type=hidden name="expname" value="gamble1-3">
            <input type=hidden name="nextURL" value="gambleCon3_1-4.php">
        ...
        <script type="text/javascript">
			...
			generateTrial("json_files/gamble4.json", "dynSet", o);
