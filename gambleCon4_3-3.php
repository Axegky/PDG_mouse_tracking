...
<FORM id="mlwebform" name="mlwebform" onSubmit="return checkForm(this)" method="POST" action="save3.php">
            ...
            <input id="expName" type=hidden name="expname" value="gamble3-3">
            <input type=hidden name="nextURL" value="gambleCon4_3-4.php">
        ...
        <script type="text/javascript">
			...
			generateTrial("json_files/gamble1.json", "dynSet", o);
