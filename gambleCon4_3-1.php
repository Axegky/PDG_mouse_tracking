...
<FORM id="mlwebform" name="mlwebform" onSubmit="return checkForm(this)" method="POST" action="save3.php">
            ...
            <input id="expName" type=hidden name="expname" value="gamble3-1">
            <input type=hidden name="nextURL" value="gambleCon4_3-2.php">
        ...
        <script type="text/javascript">
			...
			generateTrial("json_files/gamble2.json", "dynSet", o);
